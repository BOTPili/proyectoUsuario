...
import com.example.proyectousuario.databinding.ItemPlateBinding
import com.example.proyectousuario.user.entity.Plate

class PlateAdapter (var items:List<Plate>): RecyclerView.Adapter<PlateAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

        val binding = ItemPlateBinding.inflate(
    ...
    class ViewHolder(private val binding:ItemPlateBinding) :
